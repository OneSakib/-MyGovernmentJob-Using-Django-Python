"""
Django settings for mygovernmentjob project.
...
INSTALLED_APPS = [
    ...
    'mygovernmentjobs.apps.MygovernmentjobsConfig',
...
ROOT_URLCONF = 'mygovernmentjob.urls'
...
WSGI_APPLICATION = 'mygovernmentjob.wsgi.application'
